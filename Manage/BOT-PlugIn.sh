        ...
        do
          case ${plugin_number} in
           ...
           14)
             ...
             Git="${Git} https://github.moeyy.xyz/https://github.com/liuly0322/l-plugin.git"
             ;;
           15)
             Name="${Name} 千羽插件"
           ...
           21)
             ...
             Git="${Git} https://github.moeyy.xyz/https://github.com/gxy12345/windoge-plugin"
             ;;
           22)
             Name="${Name} Atlas[图鉴]"
             Plugin="${Plugin} Atlas"
           ...
           39)
             ...
             Git="${Git} https://github.moeyy.xyz/https://github.com/Catrong/phi-plugin.git"
             ;;
           40)
             Name="${Name} ap绘图插件"
           ...
           42)
             ...
             Git="${Git} https://github.moeyy.xyz/https://github.com/ikechan8370/chatgpt-plugin.git"
             ;;
           43)
             Name="${Name} 阴天插件"
    ...
    if [ "${number}" == "1" ];then
        ...
        if [[ ${js} = *gitee* ]]
            ...
            then
                if [[ ${js} = *raw* ]]
                    then
                        curl "https://github.moeyy.xyz/${js}" > ${jsname}
                elif [[ ${js} = *blob* ]]
                    then
